                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-10 col-xl-7 mx-auto">
                         ...
                         ?>
                            <form method="POST" action="<?php echo site_url('Customers/contactFunction');?>">
                                ...
                                <div class="form-group mb-3">
                                    <textarea class="form-control text-left" placeholder="Write your message." name="message" rows="10" cols="5">
                                     Write your message. 
                                    </textarea>
                                </div>
