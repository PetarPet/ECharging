                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-10 col-xl-7 mx-auto">
                            <h3 class="display-6 mb-3">Customer registration</h3>
                            <?php
                            if(isset($poruka)) { 
                            ...
                            <div class="row justify-content-center">
                                ...
                                <strong><?php echo $poruka; unset($poruka)?></strong>
                                </div>
                            </div> <?php
                            } else { ?>
                             <div class="row justify-content-center">
                         ...
                         ?>
                            <form method="POST" action="<?php echo site_url('Home/customerSignUp'); ?>" autocomplete="off">
                                <div class="form-group mb-3">
                                    <input name="firstname" id="firstname" type="text" placeholder="First name" required="" autofocus="" class="form-control rounded-pill border-0 shadow-sm px-4">
                                </div>
                                <div class="form-group mb-3">
